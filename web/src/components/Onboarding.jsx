...
const STEPS = [
  {
    icon: '👋',
    title: 'Привет в Neuro',
    body: 'Здесь у тебя сразу два чата: «Избранное» — личные заметки, и «Neuro» — туда приходят коды входа и заявки в поддержку.',
  },
  {
    icon: '✨',
  ...
  },
  {
    icon: '🐞',
    title: 'Нашёл баг?',
    body: 'В чате Neuro есть кнопки «Баг», «Идея» и «Сообщение админу». Заявки попадают прямо к создателю.',
  },
];
