# Развёртывание Allsafe

> Внутренние пути и имена процессов оставлены как `neuro` / `/opt/neuro` / `pm2 neuro-server` ради обратной совместимости с уже задеплоенными установками — менять их рискованно. Это только инфраструктурные имена; пользователи везде видят «Allsafe».
